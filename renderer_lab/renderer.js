...
renderer.setPixelRatio(Math.min(devicePixelRatio,2));renderer.setClearColor(0x101318,1);renderer.outputColorSpace=THREE.SRGBColorSpace;renderer.toneMapping=THREE.ACESFilmicToneMapping;renderer.toneMappingExposure=1;
