...
const camera=new THREE.PerspectiveCamera(32,1,.01,100);camera.position.set(0,1.1,3.2);
async function boot(){ await createRenderer(); new GLTFLoader().load("saeed.ai.glb",gltf=>{
