...
$("updateBtn").onclick=()=>window.saeed.showUpdate();
$("closeUpdate").onclick=()=>{if(window.saeedWindowMode==="update")window.saeed.closeUpdate();else $("updatePanel").classList.add("hidden")};
...
if(window.saeedWindowMode==="update")setTimeout(openUpdatePanel,0);
